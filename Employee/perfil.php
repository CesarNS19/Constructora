...
<header>
    <nav>
        ...
        <ul class="nav-links">
        <li><a href="index_employee.php"><i class="fas fa-home"></i></a></li>
            ...
            <div class="modal-body">
                <form action="update_profile.php" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nombre" id="nombre" value="<?php echo htmlspecialchars($user['nombre'] ?? ''); ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" name="correo_personal" id="correo_personal" value="<?php echo htmlspecialchars($user['correo_personal'] ?? ''); ?>">
                    </div>
                    <div class="form-group">
