...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($imagen_ruta) {
        $sql = "UPDATE servicios SET nombre_servicio='$nombre_servicio', descripcion_servicio='$descripcion_servicio', imagen_servicio='$imagen_ruta' WHERE id_servicio='$id_servicio'";
    } else {
        $sql = "UPDATE servicios SET nombre_servicio='$nombre_servicio', descripcion_servicio='$descripcion_servicio' WHERE id_servicio='$id_servicio'";
    }
